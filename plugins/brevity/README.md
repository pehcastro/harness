...
```bash
cp harness/plugins/brevity/adapters/cursor/brevity.mdc  <your-project>/.cursor/rules/
```
...
```bash
cp harness/plugins/brevity/adapters/windsurf/brevity.md  <your-project>/.windsurf/rules/
```
...
```bash
cp harness/plugins/brevity/adapters/cline/brevity.md  <your-project>/.clinerules/
```

### GitHub Copilot

```bash
cp harness/plugins/brevity/adapters/copilot/copilot-instructions.md  <your-project>/.github/
```

### Codex, Amp, and anything that reads AGENTS.md

```bash
cp harness/plugins/brevity/adapters/agents/AGENTS.md  <your-project>/
```
...
```json
{
  "statusLine": {
    "type": "command",
    "command": "sh /path/to/harness/plugins/brevity/statusline/with-style.sh --prefix --label 'output mode: ' -- 'your existing command here'"
  }
}
```
